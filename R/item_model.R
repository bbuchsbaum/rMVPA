...
#'
#' Conceptually, ITEM differs from the archived `hrfdecoder` pathway in where
#' the decoder is fit:
...
#' - The archived `hrfdecoder` model fits a continuous-time decoder directly on
#'   TR-level data and aggregates TR predictions to events afterward.
#'
