...
#' @param confound_rdms Optional named list of KxK matrices or "dist" objects (item-level
...
#' @param item_lag Optional numeric per-item retrieval-minus-encoding lag, aligned to item keys.
#' @param item_run_enc Optional factor of per-item encoding runs.
#' @param item_run_ret Optional factor of per-item retrieval runs.
