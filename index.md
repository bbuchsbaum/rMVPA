...
The unified CLI vignette is
[`vignette("CommandLine")`](http://bbuchsbaum.github.io/rMVPA/articles/CommandLine.md).
The legacy source-tree entrypoints remain available as compatibility
shims, but the packaged commands above are the supported interface.
