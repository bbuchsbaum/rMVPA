...
======= [![codecov](https://codecov.io/gh/bbuchsbaum/rMVPA/branch/master/graph/badge.svg)](https://codecov.io/github/bbuchsbaum/rMVPA?branch=master) [![Build Status](https://api.travis-ci.org/bbuchsbaum/rMVPA.svg?branch=master)](https://travis-ci.org/bbuchsbaum/rMVPA)
