...
- Predict neural patterns from a feature matrix: `vignette("Feature_RSA")` (with `vignette("Feature_RSA_Advanced_Workflows")` for extensions)
- Per-trial RSA with built-in across-block masking: `vignette("Vector_RSA")`
