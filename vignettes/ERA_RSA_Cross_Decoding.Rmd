...
A retrieval rating can be related directly to the matched-item E–R similarity
computed in each region or searchlight sphere. Missing ratings do not remove
