...
First, we demonstrate setting up feature selection using the `top_k` method, using k=1000, and the univariate F-test for feature ranking:

```{r}

fsel <- feature_selector(method="F-test",cutoff_type = "top_k", cutoff_value = 1000)
