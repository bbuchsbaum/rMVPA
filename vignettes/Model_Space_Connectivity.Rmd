...
Classic `rsa_design()` also has the same explicit nuisance channel. Nuisance
RDMs enter the fitted RSA model, but they do not define fingerprint axes:
...
```{r check-classic-nuisance, include = FALSE}
stopifnot(
  identical(classic_nuis$model_predictors, c("R_cat", "R_feat")),
  identical(classic_nuis$nuisance_predictors, "order"),
  identical(names(classic_nuis$model_mat), c("R_cat", "R_feat", "order"))
)
```
