...
This function combines the RSA standard classifier results from a good
results data frame by binding the performance rows together.
...
A list containing the combined performance matrix along with other
