...
This function performs standard searchlight analysis using a specified
model and radius. It can be customized with different MVPA functions,
combiners, and permutation options.
