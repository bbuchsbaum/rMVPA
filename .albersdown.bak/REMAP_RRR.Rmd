...
```{r minimal_example, eval=!light_build}
set.seed(1)
...
```{r inspect_diagnostics, eval=!light_build}
...
```{r summary_helpers, eval=!light_build}
...
```{r searchlight_usage, eval=!light_build}
